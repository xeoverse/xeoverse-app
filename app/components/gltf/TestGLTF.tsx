...
export function Model(props: JSX.IntrinsicElements['group']) {
  ...
  return (
    <group {...props} dispose={null}>
      <mesh castShadow receiveShadow geometry={nodes.Cube001.geometry} material={materials.jade} position={[1.768, 1.019, -0.361]} />
      ...
      <mesh castShadow receiveShadow geometry={nodes.Cylinder.geometry} material={materials['Material.002']} position={[-1.897, 0.994, -0.912]} />
    </group>
  )
}

  ...
  return (
    <group {...props} dispose={null}>
      <mesh
        ...
        position={[1.768, 1.019, -0.361]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Cone.geometry}
        material={materials.cobolt}
        position={[-2.99, 1.014, 1.397]}
      />
      <mesh
        castShadow
        receiveShadow
        geometry={nodes.Suzanne.geometry}
        material={materials["yellow-shine"]}
        position={[1.635, 2.575, -0.355]}
        rotation={[-0.653, 0.29, 0.274]}
        scale={[1, 1, 0.88]}
      />
      <mesh
        castShadow

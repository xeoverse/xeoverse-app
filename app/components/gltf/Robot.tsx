...
type ActionName = 'Golem_Attack_1' | 'Golem_Attack_2' | 'Golem_Run' | 'Golem_Walk' | 'Jackhammer_low.002'
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <group name="Stone_Golem">
          ...
          <skinnedMesh name="Golem_low" geometry={nodes.Golem_low.geometry} material={materials.Golem_2} skeleton={nodes.Golem_low.skeleton} />
          <skinnedMesh name="Golem_low001" geometry={nodes.Golem_low001.geometry} material={materials.Golem_2} skeleton={nodes.Golem_low001.skeleton} />
          <skinnedMesh name="Golem_low002" geometry={nodes.Golem_low002.geometry} material={materials.Golem_2} skeleton={nodes.Golem_low002.skeleton} />
          <skinnedMesh name="Golem_low003" geometry={nodes.Golem_low003.geometry} material={materials.Golem_2} skeleton={nodes.Golem_low003.skeleton} />
        </group>
      </group>
    </group>
  )
